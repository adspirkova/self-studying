...
// Copy all jsfrom src/js into dist
...
function watchFiles(done) {
    ...
    gulp.watch("src/js/**/*.js", gulp.series(publishJavascript, reload));
...
exports.watch = gulp.series(cleanAssets, publishHtml, publishImages, publishJavascript, compileScss, serve, watchFiles);
